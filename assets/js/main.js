...
(function ($) {
    ...
    $(function () {
        $("#mint_menu_btn").click(function () {
            ...
            $(".nova_header").removeClass("active");
        });
    });
    $(function () {
        $("#mint_menu_btn").click(function () {
            $(".nova_mint_header").removeClass("nova_header");
        });
    });
    ...
    $(function () {
        $(".menu_bar").click(function () {
            $(".nova_mobile_menu").show();
        });
        $(".mobile-menu-hide, .mobile_menu_close_btn, .mobile_menu_social_links").click(function () {
            $(".nova_mobile_menu").hide();
            $(".mobile-sub-menu-list").hide();
        });
    });
    window.onclick = function (event) {
        if (event.target == nova_mobile_menu) {
            nova_mobile_menu.style.display = "none";
        }
    }
